    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8 shadow-sm border border-blue-100">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-lg font-semibold text-gray-900">{t('publicProfile')}</h2>
        </div>

        {/* Profile Document Section */}
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
          <div className="mb-8 text-center">
            <h3 className="text-3xl font-bold text-gray-900">Erfaren softwareudvikler med over 8 års erfaring</h3>
          </div>
